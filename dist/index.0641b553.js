...
},{"./episodes.json":"99NvN","play-sound":"l1j7a"}],"99NvN":[function(require,module,exports) {
...
},{}],"l1j7a":[function(require,module,exports) {
var fs = require('fs'), findExec = require('find-exec'), spawn = require('child_process').spawn, players = [
    'mplayer',
    'afplay',
    'mpg123',
    'mpg321',
...
function Play(opts) {
    ...
    this.play = function(what, options, next) {
        ...
        if (!this.player) return next(new Error("Couldn't find a suitable audio player"));
        var args = Array.isArray(options[this.player]) ? options[this.player].concat(what) : [
            what
        ];
...
},{"fs":"jhUEF","find-exec":"lhLVI","child_process":"jhUEF"}],"jhUEF":[function(require,module,exports) {
"use strict";

},{}],"lhLVI":[function(require,module,exports) {
...
function findCommand(command) {
    if (/^win/.test(platform)) return "where " + command;
    else return "command -v " + command;
}

},{"child_process":"jhUEF","os":"6yyXu"}],"6yyXu":[function(require,module,exports) {
